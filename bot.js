...
client.on("message", (message) => {
  ...
  if (message.content.toLowerCase().startsWith(prefix + `help`)) {
    ...
    .setColor(0xCF40FA)
    .setDescription(`Hello! I'm power ticket, the Discord bot for super cool support ticket stuff and more! Here are my commands:`)
    .addField(`Tickets`, `[${prefix}new]() > Opens up a new ticket and tags the Support Team\n[${prefix}close]() > Closes a ticket that has been resolved or been opened by accident`)
    .addField(`Other`, `[${prefix}help]() > Shows you this help menu your reading\n[${prefix}ping]() > Pings the bot to see how long it takes to react\n[${prefix}about]() > Tells you all about power ticket`)
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`power ticket - Script By : SAJED`);
        console.log(`----------------`);
